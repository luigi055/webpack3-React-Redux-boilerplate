...
const Features = props => (
  <div className="features">
    ...
    <ul>
      <li>React, ReactDOM, Redux, React-Redux, React-Router, Redux-Thunk
          <i className="fa fa-thumbs-up" />
      </li>
      <li>Full sass support for Foundation 6 and Font Awesome</li>
      <li>PostCSS configured to be used from ie9 and some legacy browser fallbacks supported</li>
      <li>Images loader with images-webpack-loader which load and optimize your images </li>
      ...
      <li>Extract-Text-Plugin so you could separate your style.css from the bundle.js</li>
